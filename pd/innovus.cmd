...
#  Created on Sun Nov  9 16:02:47 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.72484 -from {0x14 0x17} -to 0x18 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.72484 -from {0x1b 0x1e} -to 0x1f -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.72484 -from 0x21 -to 0x22
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.72484 -from 0x25 -to 0x26
setPathGroupOptions reg2reg_tmp.72484 -effortLevel high
reset_path_group -name in2out_tmp.72484
...
all_setup_analysis_views
getPlaceMode -exp_slack_driven -quiet
reset_path_group -name reg2reg_tmp.72484
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2out_tmp.72484
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.72484
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.72484 -from {0x2a 0x2d} -to 0x2e -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.72484 -from {0x31 0x34} -to 0x35 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.72484 -from 0x37 -to 0x38
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.72484 -from 0x3b -to 0x3c
setPathGroupOptions reg2reg_tmp.72484 -effortLevel high
reset_path_group -name in2out_tmp.72484
set_global _is_ipo_interactive_path_groups 0
setDelayCalMode -ignoreNetLoad false
...
set_ccopt_property insertion_delay -pin {wptr_full_inst/wptr_reg[4]/CK} 0.032
