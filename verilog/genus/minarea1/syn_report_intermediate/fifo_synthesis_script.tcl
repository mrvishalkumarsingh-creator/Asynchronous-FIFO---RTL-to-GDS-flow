...
# Created by Genus(TM) Synthesis Solution 19.13-s073_1 on Mon Oct 13 19:31:37 IST 2025
...
set_db -quiet runtime_by_stage { {to_generic 0 6 0 6}  {first_condense 1 8 2 9}  {reify 1 9 4 13}  {global_incr_map 0 9 0 13}  {incr_opt 0 9 0 14} }
set_db -quiet tinfo_tstamp_file .rs_vishal25157.tstamp
set_db -quiet metric_enable true
set_db -quiet flow_metrics_snapshot_uuid e3a9e610-5c83-412d-9905-a012fd567a48
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name wclk -domain domain_1 -period 6000.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:FIFO port:FIFO/wclk
...
set_db -quiet design:FIFO .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 6458} {cell_count 304} {utilization  0.00} {runtime 0 6 0 6} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 7694} {cell_count 596} {utilization  0.00} {runtime 1 8 2 9} }{reify {wns 3235} {tns 0} {vep 0} {area 4413} {cell_count 359} {utilization  0.00} {runtime 1 9 4 13} }{global_incr_map {wns 3235} {tns 0} {vep 0} {area 4404} {cell_count 357} {utilization  0.00} {runtime 0 9 0 14} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 4404} {cell_count 357} {utilization  0.00} {runtime 0 9 0 14} }}
...
## Written on 19:31:37 13-Oct 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid e3a9e610-5c83-412d-9905-a012fd567a48}
