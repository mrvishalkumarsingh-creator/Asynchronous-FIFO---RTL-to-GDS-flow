...
set_db -quiet runtime_by_stage { {to_generic 0 7 0 6}  {first_condense 1 8 2 9}  {reify 1 9 4 13}  {global_incr_map 1 10 0 14}  {incr_opt 0 10 0 14} }
set_db -quiet tinfo_tstamp_file .rs_vishal25157.tstamp
set_db -quiet metric_enable true
set_db -quiet flow_metrics_snapshot_uuid 244a1dc4-9e69-4e7c-b0a1-3dd64a218715
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name wclk -domain domain_1 -period 4000.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:FIFO port:FIFO/wclk
...
set_db -quiet design:FIFO .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 6458} {cell_count 304} {utilization  0.00} {runtime 0 7 0 6} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 7694} {cell_count 596} {utilization  0.00} {runtime 1 8 2 9} }{reify {wns 1212} {tns 0} {vep 0} {area 4414} {cell_count 361} {utilization  0.00} {runtime 1 9 4 13} }{global_incr_map {wns 1189} {tns 0} {vep 0} {area 4404} {cell_count 359} {utilization  0.00} {runtime 1 10 0 14} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 4402} {cell_count 357} {utilization  0.00} {runtime 0 10 0 14} }}
...
## Written on 19:22:51 13-Oct 2025
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 244a1dc4-9e69-4e7c-b0a1-3dd64a218715}
